...
:::info Wordt gegenereerd

Deze sectie wordt automatisch gegenereerd uit de `.ttl`-bronbestanden, vergelijkbaar met [personsincontext.org/model](https://www.personsincontext.org/model/). De generator is nog niet gebouwd; tot die tijd is de [Widoco-documentatie](https://oorlogsbronnen.github.io/application-profile/) de actuele bron.

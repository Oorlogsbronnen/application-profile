...
- de beschikbare Linked Data-server: [LDmax](https://platform.ldmax.nl/organisaties/wo2net) (organisatie Stichting WO2Net), met SPARQL-endpoint `https://sparql.ldmax.nl/wo2net` (de query-UI staat op `https://platform.ldmax.nl/organisaties/wo2net/query`) en als relevante datasets [`wo2net/personen`](https://platform.ldmax.nl/datasets/wo2net/personen/) en [`wo2net/collecties`](https://platform.ldmax.nl/datasets/wo2net/collecties/) (beide CC-BY-NC-SA 4.0). Let op: de data zelf gebruikt `http://schema.org/` (http) en `pico:` = `https://personsincontext.org/model#` — dat wijkt af van het profiel (zie `specs/2026-07-28-data-tastbaar-maken.md`);
